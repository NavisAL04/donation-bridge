...
## Step 6 — Deploy ke Render

1. Buka **render.com** → Login with GitHub
2. Klik **+ New → Web Service**
3. Klik **Connect** di repo `donation-bot` kamu
4. Isi form:
...
## Step 7 — Isi Environment Variables di Render

Klik tab **Environment → Add Environment Variable**:

| Key | Value |
|---|---|
| `ROBLOX_API_KEY` | API key Roblox kamu |
| `UNIVERSE_ID` | Universe ID game kamu |
...
> ⚠️ Untuk `GOOGLE_SERVICE_ACCOUNT_JSON`: buka file JSON → **Ctrl+A → Ctrl+C** → paste langsung sebagai value

Klik **Save Changes** → Render otomatis redeploy.

---

## Step 8 — Cek Semua Jalan

Buka URL Render di browser:
```
https://donation-bot.onrender.com
